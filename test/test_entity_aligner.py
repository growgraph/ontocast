...
def test_align_identical_graphs_produces_cross_graph_clusters() -> None:
    ...
    install_fake_encoder(aligner.clusterer, fake_encode)
...
def test_strict_regime_fewer_cross_graph_edges() -> None:
...
def test_align_matches_identical_labels_despite_low_embedding() -> None:
...
def test_align_class_entity_matches_instance_of_that_class() -> None:
    predicted_graph = RDFGraph()
    gt_graph = RDFGraph()
...
def test_align_same_ontology_uri_without_labels_despite_low_embedding() -> None:
    predicted_graph = RDFGraph()
    gt_graph = RDFGraph()
...
def test_align_same_uri_clusters_in_strict_regime() -> None:
    predicted_graph = RDFGraph()
    gt_graph = RDFGraph()
