...
def enhanced_criticise_ontology(state: AgentState, tools: ToolBox) -> AgentState:
    ...
    try:
        ...
        if critique.is_satisfactory:
            ...
            state.status = Status.FAILED
            state.failure_stage = FailureStages.CRITICISE_ONTOLOGY
        ...
        state.set_failure(FailureStages.CRITICISE_ONTOLOGY, str(e))
        return state
