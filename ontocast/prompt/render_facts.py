...
6. Maximize Ontology Entity Reuse (Individuals, Classes, Properties): If a specific individual, class, or property exists in the ontology and semantically matches a concept found in the text, use its IRI. DO NOT create a cd: IRI with the same local name or a semantically equivalent individual.
